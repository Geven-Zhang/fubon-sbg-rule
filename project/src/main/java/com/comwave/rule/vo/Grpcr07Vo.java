...
public class Grpcr07Vo {
    ...
    public Double calculateDebtRate(Grpcr07Vo grpcr07Vo){
        ...
        if (internalTotalLoanAmount.doubleValue()==0 && internalFolkTotalLoanAmount.doubleValue()==0 && overseasTotalLoanAmount.doubleValue()==0){
            ...
            return (int)(totalDebtAmount.divide(totalContractAmount,4,BigDecimal.ROUND_FLOOR).doubleValue() * 10000)/100.0;
        }else{
            return null;
        }
    }
